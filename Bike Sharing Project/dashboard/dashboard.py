...
with col1:
    ...
    st.metric("Total sewa", value=rent_amount)
...
plt.title('Total Harian Bike Sharing', fontsize=20)
...
plt.title('Jumlah Sepeda yang Disewa Setiap Bulan (2011-2012)')
plt.xlabel('Bulan')
plt.ylabel('Jumlah')
...
plt.title('Jumlah Sepeda yang Disewa Berdasarkan Musim dan Tahun')
plt.xlabel('Season')
plt.ylabel('Jumlah')
